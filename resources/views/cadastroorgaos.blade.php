                ...
                <form method="post" id="form" name="form" action="cadastro_incluir.php" class="bs-example form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="checkbox" id="cornea[]" name="cornea[]" value="Córnea"> <span>Córnea</span>&#160;&#160;
                                <input type="checkbox" id="cornea[]" name="cornea[]" value=""> <span>Coração</span>&#160;&#160;
                                <input type="checkbox" id="cornea[]" name="cornea[]" value="Rins"> <span>Rins</span>&#160;&#160;
                                <input type="checkbox" id="cornea[]" name="cornea[]" value="Fígado"> <span>Fígado</span>&#160;&#160;
                                <input type="checkbox" id="cornea[]" name="cornea[]" value="Pulmões"> <span>Pulmões</span>&#160;&#160;
                                <input type="checkbox" id="cornea[]" name="cornea[]" value="Pâncreas"> <span>Pâncreas</span>&#160;&#160;
                            </div>
                        </div>
