        ...
        <div class="col-lg-12">   
            <div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="well">
                        <form method="post" id="form" name="form" action="{{ route('orgaos.update', $orgao) }}" class="bs-example form-horizontal">
                            <fieldset>
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" id="nome" name="nome" placeholder="Nome" type="text"  maxlength="40" autofocus="" value="{{ $orgao->nome }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input onkeypress="valida_cpf();" class="form-control" id="cpf" name="cpf" placeholder="12345678910" type="text"  value="{{ $orgao->cpf }}" maxlength="11" autofocus="" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="date" name="nascimento" id="nascimento" class="form-control" value="{{ $orgao->nascimento }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                        <input class="form-control" id="estado" name="estado" type="text" value="{{ $orgao->estado }}">				
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div id="divCidade"  >
                                            <input class="form-control" id="cidade" name="cidade" type="text" value="{{ $orgao->cidade }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" id="endereco" name="endereco" placeholder="Endereço" type="text" value="{{ $orgao->endereco }}" maxlength="100" autofocus="" />
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input  type="text" class="form-control" placeholder="emailprincipal" id="emailPrincipal" name="emailprincipal" size="50" value="{{ $orgao->emailprincipal }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" placeholder="emailalternativo" id="emailAlternativo" name="emailalternativo" size="50" value="{{ $orgao->emailalternativo }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" id="numerowhatsapp" name="numerowhatsapp" placeholder="55999999999" type="text"  value="{{ $orgao->numerowhatsapp }}" maxlength="15" autofocus="" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" id="outrocontato" name="outrocontato" placeholder="55999999999" type="text"  value="{{ $orgao->outrocontato }}" maxlength="15" autofocus="" />
                                    </div>
                                </div>
